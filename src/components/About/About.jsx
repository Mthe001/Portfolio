    ...
    return (
        <section id="about" className="about min-h-screen w-full py-16 md:py-24 lg:py-32 bg-background">
            <div className="container mx-auto px-6 lg:px-12 text-center">
                ...
                {/* Profile & Description */}
                <motion.div
                    className="flex flex-col md:flex-row justify-between items-center w-8/12 mx-auto border-2 py-8 px-6 rounded-lg"
                ...
                >
                    {/* Profile Image */}
                    <motion.img
                        src="/assets/mthe001.png"
                        alt="MD Redwanul Haque"
                        className="rounded-full border  lg:w-64 md:w-52 md:h-52 w-36 h-36 lg:h-64 object-cover shadow-lg"
                    />
